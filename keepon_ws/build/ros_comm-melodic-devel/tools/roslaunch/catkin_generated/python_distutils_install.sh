...
echo_and_run cd "/home/david/keepon_ws/src/ros_comm-melodic-devel/tools/roslaunch"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/david/keepon_ws/src/ros_comm-melodic-devel/tools/roslaunch/setup.py" \
    build --build-base "/home/david/keepon_ws/build/ros_comm-melodic-devel/tools/roslaunch" \
    install \
    $DESTDIR_ARG \
