...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MigratedImplicit>)))
  ...
  "90cb5a45bdc5b3810920ed0b9d482572")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MigratedImplicit)))
  "Returns md5sum for a message object of type 'MigratedImplicit"
  "90cb5a45bdc5b3810920ed0b9d482572")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MigratedImplicit>)))
  ...
  (cl:format cl:nil "Header  header~%MigratedExplicit field4 #(58.2 \"aldfkja 17\", 82)~%string  field3 #\"kljene\"~%float32 field2 #16.32~%int32   field1 #34~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: test_rosbag/MigratedExplicit~%Header  header~%float32 field2 #58.2~%string  combo_field3 #\"aldfkja 17\"~%int32   field4 #82~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MigratedImplicit)))
  "Returns full string definition for message of type 'MigratedImplicit"
  (cl:format cl:nil "Header  header~%MigratedExplicit field4 #(58.2 \"aldfkja 17\", 82)~%string  field3 #\"kljene\"~%float32 field2 #16.32~%int32   field1 #34~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: test_rosbag/MigratedExplicit~%Header  header~%float32 field2 #58.2~%string  combo_field3 #\"aldfkja 17\"~%int32   field4 #82~%~%~%"))
