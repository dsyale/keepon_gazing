...
(cl:defmethod field4-val ((m <PartiallyMigrated>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PartiallyMigrated>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'field4))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'field5))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PartiallyMigrated>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'field2) istream)
    ...
    (cl:setf (cl:slot-value msg 'field4) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:setf (cl:slot-value msg 'field5) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PartiallyMigrated>)))
  ...
  "45f99fcf57ef956dd2a6a16472643507")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PartiallyMigrated)))
  "Returns md5sum for a message object of type 'PartiallyMigrated"
  "45f99fcf57ef956dd2a6a16472643507")
